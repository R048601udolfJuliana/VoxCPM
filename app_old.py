...
class VoxCPMDemo:
    def __init__(self) -> None:
        ...
        self.asr_model: Optional[AutoModel] = AutoModel(
            ...
            disable_update=True,
            log_level='WARNING',  # personal preference: reduce noisy DEBUG logs
            device="cuda:0" if self.device == "cuda" else "cpu",
        )

        # TTS model (lazy init)
        self.voxcpm_model: Optional[voxcpm.VoxCPM] = None
        # NOTE: changed default dir to match my local setup where models live under ./checkpoints/VoxCPM1.5
    ...
    def prompt_wav_recognition(self, prompt_wav: Optional[str]) -> str:
        # Return empty string early if no audio file was provided
